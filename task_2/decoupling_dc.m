...
f = figure(1);
f.Name = 'margin_G11_norm_decoupling_dc';
...
f = figure(2);
f.Name = 'margin_G22_norm_decoupling_dc';
...
f = figure(3);
f.Name = 'margin_KG11_norm_decoupling_dc';
...
f = figure(4);
f.Name = 'margin_KG22_norm_decoupling_dc';
...
K_decoupling_dc = Du*K_norm*Dy^-1;
